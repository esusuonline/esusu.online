...
class TicketController extends Controller
{
    ...
    public function supportTicket()
    {
        ...
        $supports = SupportTicket::where('staff_id', Auth::guard('staff')->id())->orderBy('priority', 'desc')->orderBy('id','desc')->paginate(getPaginate());
    ...
    public function openSupportTicket()
    {
        ...
        return view('staff.support.create', compact('pageTitle', 'staff'));
    }
    ...
    public function storeSupportTicket(Request $request)
    {
        ...
        $ticket->name = $request->firstname.' '.$staff->lastname;
        $ticket->email = $staff->email;
        ...
        $adminNotification->staff_id = $staff->id;
        $adminNotification->title = 'New support ticket has opened';
        $adminNotification->click_url = urlPath('admin.staff.ticket.view',$ticket->id);
        ...
        return redirect()->route('staff.ticket')->withNotify($notify);
    }
    ...
    public function viewTicket($ticket)
    {
        ...
        $my_ticket = SupportTicket::where('ticket', $ticket)->where('staff_id',Auth::guard('staff')->id())->orderBy('id','desc')->firstOrFail();
        $messages = SupportMessage::where('supportticket_id', $my_ticket->id)->orderBy('id','desc')->get();

        return view('staff.support.view', compact('my_ticket', 'messages', 'pageTitle'));

    }

    public function replyTicket(Request $request, $id)
    {
        $ticket = SupportTicket::where('staff_id', Auth::guard('staff')->id())->where('id',$id)->firstOrFail();
        $message = new SupportMessage();
