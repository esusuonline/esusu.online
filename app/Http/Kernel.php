...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'staff.checkStatus' => \App\Http\Middleware\CheckStaffStatus::class,
        
        'fsp' => \App\Http\Middleware\RedirectIfNotFsp::class,
        'fsp.guest' => \App\Http\Middleware\RedirectIfFsp::class,
        'fsp.checkStatus' => \App\Http\Middleware\CheckFspStatus::class,
