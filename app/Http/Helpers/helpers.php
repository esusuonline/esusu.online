...
{
    $jsonUrl = resource_path('views/user/sections.json');
...
function imagePath()
{
    ...
    $data['verify'] = [
        ...
        'savings'=>[
            'path'=>'assets/images/verify/savings'
        ]
    ];
    $data['image'] = [
    ...
    $data['profile'] = [
        ...
        'staff'=> [
            'path'=>'assets/images/staff/profile',
            'size'=>'350x300'
        ],
        'fsp'=> [
            'path'=>'assets/images/fsp/profile',
            'size'=>'350x300'
        ],
        'admin'=> [
...
function installmentInterval($daysInterval, $days){
    $getIndex = array_search($daysInterval, array_column($days, 'day')) ?? false;

    if(gettype($getIndex) == 'integer'){
        return @$days[$getIndex]['name'];
    }
