...
<nav class="navbar-wrapper">
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu">
        ...
        <span class="dropdown-menu__caption mr-3 text-dark">@lang('Withdrawable Funds') <br> <span class="float-right text-dark">(&#8358; {{ number_format((Auth::user()->withdrawable_funds), 2) }})</span></span>  </a>
        <div class="dropdown-divider"></div> 
        
        <a class="dropdown-item" href="#"><i style="color: #E91E63" class="dropdown-menu__icon fas fa-coins mr-2"></i>
        <span class="dropdown-menu__caption mr-3 text-dark">@lang('Total Assets') <br> <span class="float-right text-dark">(&#8358; {{ number_format((Auth::user()->total_assets), 2) }}) <i class="fas fa-lock ml-1"></i></span></span></a>
        <div class="dropdown-divider"></div>
        
        <a class="dropdown-item" href="#"><i style="color: #E91E63" class="dropdown-menu__icon fas fa-wallet mr-2"></i>
        <span class="dropdown-menu__caption mr-3 text-dark">@lang('Active Savings Balance') <br> <span class="float-right text-dark">(&#8358; {{ number_format((Auth::user()->active_savings_balance), 2) }}) <i class="fas fa-lock ml-1"></i></span></span></a>
