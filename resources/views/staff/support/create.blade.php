...
<div class="row">
    <div class="col-lg-12">
        <div class="card">              
            <div class="card-body">
                <form  action="{{route('staff.ticket.store')}}"  method="post" enctype="multipart/form-data" onsubmit="return submitUserForm();">
                    @csrf
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="name" class="w-100" >@lang('Name') <span class="text-danger">*</span></label>
                            <input type="text" name="name" value="{{@$staff->firstname . ' '.@$staff->lastname}}" class="form-control" placeholder="@lang('Enter your name')" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="email" class="w-100">@lang('Email address')  <span class="text-danger">*</span></label>
                            <input type="email"  name="email" value="{{@$staff->email}}" class="form-control" placeholder="@lang('Enter your email')" readonly>
                        </div>
                ...
                $("#fileUploadsContainer").append(`
                    <div class="input-group my-3">
                        ...
                        <div class="input-group-append">
                            <span class="input-group-text btn btn--danger support-btn remove-btn border-0"> <i class="fa fa-times m-0 px-2"></i></span>
                        </div>                     
                    </div>
                `)
            });
