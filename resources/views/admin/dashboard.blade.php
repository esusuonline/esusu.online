...
@section('panel')
    ...
    <div class="mt-4 mb-2"><span class="border border--primary bg--white text--primary px-3 py-1 rounded">@lang('Staffs')</span></div>
    <div class="row mb-none-30">
        <div class="col-xl-3 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--info b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['total_staffs']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total')</span>
                    </div>
                    <a href="{{route('admin.staffs.all')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--green b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['active_staffs']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Active')</span>
                    </div>
                    <a href="{{route('admin.staffs.active')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--danger b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['email_unverified_staffs']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Email Unverified')</span>
                    </div>

                    <a href="{{route('admin.staffs.email.unverified')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--16 b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['sms_unverified_staffs']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('SMS Unverified')</span>
                    </div>

                    <a href="{{route('admin.staffs.sms.unverified')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->

    <div class="mt-4 mb-2"><span class="border border--primary bg--white text--primary px-3 py-1 rounded">@lang('Collections')</span></div>
    <div class="row mb-none-30">
        <div class="col-xl-3 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--19 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ showAmount($widget['yesterday_collection']) }}</span>
                        <span class="currency-sign">{{__($general->cur_text)}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Yesterday Collection')</span>
                    </div>
                    <a href="{{ route('admin.collection.all', 'yesterday') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--teal b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ showAmount($widget['today_collection']) }}</span>
                        <span class="currency-sign">{{__($general->cur_text)}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Today Collection')</span>
                    </div>
                    <a href="{{ route('admin.collection.all', 'today') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--18 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ showAmount($widget['today_loan_collection']) }}</span>
                        <span class="currency-sign">{{__($general->cur_text)}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Today Loan Collection')</span>
                    </div>
                    <a href="{{ route('admin.collection.loan', 'today') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--10 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ showAmount($widget['today_savings_collection']) }}</span>
                        <span class="currency-sign">{{__($general->cur_text)}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Today Savings Collection')</span>
                    </div>
                    <a href="{{ route('admin.collection.savings', 'today') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
    </div>
