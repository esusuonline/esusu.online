                        ...
                        <div class="row mb-none-15">
                            <div class="col-lg-12 col-xl-4">
                                <div class="form-group">
                                    <label class="w-100 font-weight-bold">@lang('Plan Name') <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="name" value="{{ $plan->name??old('name') }}" required/>
                                </div>
                            </div>
                            <div class="col-sm-12 col-xl-4 col-lg-6">
                                <div class="form-group">
                                    <label class="w-100 font-weight-bold receive-times">@lang('Savings Per Installment')</label>
                            ...
                            <div class="col-sm-12 col-xl-4 col-lg-6">
                                <div class="form-group">
                                    <label class="w-100 font-weight-bold">@lang('Total Installments') <span class="text-danger">*</span></label>
                            ...
                            <div class="col-sm-12 col-xl-4 col-lg-6">
                                <div class="form-group">
                                    <label class="w-100 font-weight-bold">@lang('Amount To Be Returned') <span class="text-danger">*</span></label>
                                    <div class="input-group has_append">
