        ...
        <div class="col-xl-9 col-lg-7 col-md-7 mb-30">
            <div class="row mb-none-30">
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--green b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.loan.user',$user->id) }}" class="item--link"></a>
                        <div class="icon">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--cyan b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.savings.user',$user->id) }}" class="item--link"></a>
                        <div class="icon">
                    ...
                    <form action="{{route('admin.users.update',[$user->id])}}" method="POST"
                                ...
                                <div class="form-group ">
                                    ...
                                    <select name="country" class="form-control">
                                        @foreach($countries as $key => $country)
                                            <option value="{{ $key }}" data-mobile_code="{{ $country->dial_code }}" @if($country->country == @$user->address->country ) selected @endif>{{ __($country->country) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group  col-xl-4 col-md-6  col-sm-3 col-12">
                                ...
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Verified')" data-off="@lang('Unverified')" name="ev"
