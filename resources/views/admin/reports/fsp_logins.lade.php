                        ...
                        <table class="table table--light style--two">
                            ...
                            @forelse($login_logs as $log)
                                ...
                                <td data-label="@lang('User')">
                                    <span class="font-weight-bold">{{ @$log->fsp->fullname }}</span>
                                    <br>
                                    <span class="small"> <a href="{{ route('admin.fsps.detail', $log->fsp_id) }}"><span>@</span>{{ @$log->fsp->username }}</a> </span>
                                </td>
                                    ...
                                    <td data-label="@lang('IP')">
                                        ...
                                        <a href="{{route('admin.report.fsp.login.ipHistory',[$log->user_ip])}}">{{ $log->user_ip }}</a>
                                        </span>
                                    </td>
...
@push('breadcrumb-plugins')
    @if(request()->routeIs('admin.report.fsp.login.history'))
    <form action="{{ route('admin.report.fsp.login.history') }}" method="GET" class="form-inline float-sm-right bg--white">
    ...
    @endif
@endpush
@if(request()->routeIs('admin.report.fsp.login.ipHistory'))
    @push('breadcrumb-plugins')
