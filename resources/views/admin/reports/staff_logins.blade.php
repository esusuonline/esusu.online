                        ...
                        <table class="table table--light style--two">
                            ...
                            @forelse($login_logs as $log)
                                ...
                                <td data-label="@lang('User')">
                                    ...
                                    <br>
                                    <span class="small"> <a href="{{ route('admin.staffs.detail', $log->staff_id) }}"><span>@</span>{{ @$log->staff->username }}</a> </span>
                                </td>
                                    ...
                                    <td data-label="@lang('IP')">
                                        ...
                                        <a href="{{route('admin.report.staff.login.ipHistory',[$log->user_ip])}}">{{ $log->user_ip }}</a>
                                        </span>
                                    </td>
...
@push('breadcrumb-plugins')
    @if(request()->routeIs('admin.report.staff.login.history'))
    <form action="{{ route('admin.report.staff.login.history') }}" method="GET" class="form-inline float-sm-right bg--white">
    ...
    @endif
@endpush
@if(request()->routeIs('admin.report.staff.login.ipHistory'))
    @push('breadcrumb-plugins')
