        ...
        <div class="col-xl-9 col-lg-8 col-md-7 mb-30">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('fsp.change.password') }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">@lang('Password')</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="password" placeholder="@lang('Password')" name="current_password" required>
                            </div>
                        </div>
...
@push('breadcrumb-plugins')
    <a href="{{route('fsp.profile')}}" class="btn btn-sm btn--primary box--shadow1 text--small" ><i class="fa fa-user"></i>@lang('Profile Setting')</a>
@endpush
