...
@php
    $fsp = DB::table('fsps')->where('id', Auth::guard('fsp')->user()->id)->first();
@endphp
<div class="row mb-none-30">
    ...
    <div class="col-12">
        <div class="alert alert-danger alert-dismissible fade show text-center p-3" style="font-size:16px; background: #d9534f; color: white">
          <strong>
                You're yet to fll in your company's CAC info. Click <span><a href="{{ route('fsp.profile') }}" class="text-warning">here</a></span> to do that
          </strong>
    ...
    <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
        <div class="dashboard-w1 bg--primary b-radius--10 box-shadow">
            ...
            <div class="details">
                ...
                <a href="{{ route('fsp.payment.loan.history', 'today') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
    ...
    <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
        <div class="dashboard-w1 bg--teal b-radius--10 box-shadow">
            ...
            <div class="details">
                ...
                <a href="{{ route('fsp.payment.savings.history', 'today') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
...
<div class="card b-radius--10 mt-4">
    <div class="card-header">
        ...
        <a href="{{ route('fsp.payment.history') }}" class="btn btn-sm btn--primary box--shadow1 text--small float-right">@lang('View All')</a>
    </div>
        ...
        <div class="table-responsive--md  table-responsive">
            <table class="table table--light style--two">
                ...
                <tr>
                    ...
                    @if (request()->routeIs('fsp.dashboard'))
                        <th>@lang('Type')</th>
                    @endif
