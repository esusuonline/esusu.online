                ...
                <form action="{{ route('fsp.plan.loan.save', $plan->id??0) }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-xl-4 col-lg-6">
                                <div class="form-group">
                                    <label class="w-100 font-weight-bold">@lang('Loan Plan Interest') <span class="text-danger">*</span></label>
                                    <div class="input-group has_append">
                            ...
                            <div class="col-sm-12 col-xl-4 col-lg-6">
                                <div class="form-group">
                                    <label class="w-100 font-weight-bold">@lang('Total Installemental Payments') <span class="text-danger">*</span></label>
                            ...
                            */
                            ...
                            <div class="form-group mt-3">
                                <label class="font-weight-bold">@lang('Loan Plan Description')</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-xl-4 col-lg-6">
                                <div class="form-group">
                                    <label class="w-100 font-weight-bold">@lang('Loan Plan Name') <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="name" value="{{ $plan->name??old('name') }}" required/>
                                </div>
