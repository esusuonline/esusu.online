                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    ...
                                    <a href="{{ route("fsp.payment.$type.history", [\Carbon\Carbon::parse($collection->created_at)->format('Y-m-d'), $collection->admin_receive]) }}" class="icon-btn ml-1" data-toggle="tooltip" title="" data-original-title="@lang('View All')">
