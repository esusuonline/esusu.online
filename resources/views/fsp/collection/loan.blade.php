                ...
                <div class="table-responsive--md  table-responsive">
                    <table class="table table--light style--two">
                        ...
                        <tr>
                            ...
                            <td data-label="@lang('Loan Start')">
                                <span> 
                                    @if($loan->loan_repay_start == NULL)
                                        N/A
                                    @else
                                        {{ date('d-m-Y', strtotime($loan->loan_repay_start)) }}
                                    @endif
                                </span>
                            </td>
                            <td data-label="@lang('Loan End')">
                                </span> 
                                    @if($loan->loan_repay_end == NULL)
                                        N/A
                                    @else
                                        {{ date('d-m-Y', strtotime($loan->loan_repay_end)) }}
                                    @endif
                                </span>
                                
                            </td>
                            <td data-label="@lang('Last/Next Repayment')">
                                <span class="text-danger">Next Pay: 
                                    
                                    <span> 
                                        @if($loan->next_pay == NULL)
                                            N/A
                                        @else
                                            {{ date('d-m-Y', strtotime($loan->next_pay)) }}
                                        @endif
                                    </span>
