    ...
    <div class="row">
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <form action="{{ route('fsp.loan.apply', $plan->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
...
@push('breadcrumb-plugins')
    <a href="{{ route('fsp.loan.plan') }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="la la-fw la-backward"></i> @lang('Go Back') </a>
@endpush
